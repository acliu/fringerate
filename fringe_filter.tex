...
the simple parametrization for optimal weighting used in \citet{ali_et_al2015} (red),
...
are the weighting for reducing polarization leakage (blue), as described in Section \ref{sec:polbeams}, as well
...
in black. XXX: maybe avoid using blue and read in the bottom plot to avoid the visual implication
that the blue and red curves in the two plots are supposed to correspond to one another
}
