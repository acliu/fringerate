...
In this section, we have provided some basic intuition for fringe-rate filtering, and have highlighted how it can be used in for both 
...
\widetilde{V}_b (f_n) = \int d\Omega \,T(\hat{\mathbf{r}}) g_{bn} (\hat{\mathbf{r}}) \approx \frac{4 \pi}{N}  \sum_i T(\hat{\mathbf{r}}_i) g_{bn} (\hat{\mathbf{r}}_i),
\end{equation}
