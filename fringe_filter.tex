...
are Fourier transformed in time into fringe-rate space and weighted. Different fringe rates
...
% XXX match Omega_PP throughout text
...
% XXX Check out if we can get better polarization match with correct weighting
